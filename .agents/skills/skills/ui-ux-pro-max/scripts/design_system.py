...
class DesignSystemGenerator:
    ...
    def generate(self, query: str, project_name: str = None,
        ...
        # Resolve the mode from the style + query first, then pick a palette tha
...
# ============ OUTPUT FORMATTERS ============
BOX_WIDTH = 90  # Wider box for more conten
...
def persist_design_system(design_system: dict, page: str = None, output_dir: str = None,
    ...
    # If page is specified, create page override file with intelligent conten
    if page:
...
def format_page_override_md(design_system: dict, page_name: str, page_query: str = None) -> str:
    ...
    # Page-specific rules with actual conten
...
def _generate_intelligent_overrides(page_name: str, page_query: str, design_system: dict) -> dict:
    ...
    Uses the existing search infrastructure to find relevant style, UX, and layou
    ...
    # Detect page type from search results or contex
